...
#define __QUEUE_TIPO_DE_BUSCA_NA_FILA__ __QUEUE_PERCORRE_FILA_ESQUERDA_PARA_DIREITA__

#if __QUEUE_DEBUG__ == 1
...
#undef __QUEUE_PERCORRE_FILA_EM_AMBOS_OS_SENTIDOS__
#undef __QUEUE_PERCORRE_FILA_DIREITA_PARA_ESQUERDA__
#undef __QUEUE_PERCORRE_FILA_ESQUERDA_PARA_DIREITA__
#undef __QUEUE_DEBUG__
#undef __QUEUE_TIPO_DE_BUSCA_NA_FILA__
#undef __QUEUE_STD_MSG_ERRO__