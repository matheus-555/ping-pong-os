...
//
#define __PPOS_LOCK_INIT()      unsigned char is_user_task_tmp;             \
                                __sync_fetch_and_and(&is_user_task_tmp, 0); \
                                __sync_fetch_and_or(&is_user_task_tmp, ppos_core_task_current->is_user_task)

//
#define __PPOS_LOCK_PREEMP()    __sync_fetch_and_and(&ppos_core_task_current->is_user_task, 0)

//
#define __PPOS_UNLOCK_PREEMP()  __sync_fetch_and_or(&ppos_core_task_current->is_user_task, is_user_task_tmp)
